...
# 上半图：每日借阅量趋势
ax1.bar(daily["借阅日期"], daily["外借"], color=color.bar_color1, alpha=color.alpha,label="Borrowings")
ax1.bar(daily["借阅日期"],daily["续借"],bottom=daily["外借"],color=color.bar_color2, alpha=color.alpha,label="Renewals")
...
# 下半图：TOP10 日期柱状图
ax2.barh(range(len(top10)), top10["外借"], color=color.bar_color1, alpha=color.alpha,label="Borrowings")
ax2.barh(range(len(top10)), top10["续借"],left=top10["外借"],color=color.bar_color2,alpha=color.alpha,label="Renewals")
...
ax3.bar(month["借阅年月"],month["外借"],color=color.bar_color1, alpha=color.alpha,width=10,label="Borrowings")
ax3.bar(month["借阅年月"],month["续借"],bottom=month["外借"],color=color.bar_color2, alpha=color.alpha,width=10,label="Renewals")
...
ax3.set_xlabel("Date")
bar_width = 10
g10.bar(G10_processed["借阅年月"],G10_processed["外借"],color=color.bar_color1,width=bar_width,alpha=color.alpha)
g10.bar(G10_processed["借阅年月"],G10_processed["续借"],color=color.bar_color2,bottom=G10_processed["外借"],width=bar_width,alpha=color.alpha)
g11.bar(G11_processed["借阅年月"],G11_processed["外借"],color=color.bar_color1,width=bar_width,alpha=color.alpha)
g11.bar(G11_processed["借阅年月"],G11_processed["续借"],color=color.bar_color2,bottom=G11_processed["外借"],width=bar_width,alpha=color.alpha)
g12.bar(G12_processed["借阅年月"],G12_processed["外借"],color=color.bar_color1,width=bar_width,alpha=color.alpha)
g12.bar(G12_processed["借阅年月"],G12_processed["续借"],color=color.bar_color2,bottom=G12_processed["外借"],width=bar_width,alpha=color.alpha)
