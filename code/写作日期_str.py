...
# borrow_sum.axvline(x=year_mean, color="red", linestyle="--", label=f'center:{year_mean}')
borrow_sum.legend()
...
# a=[1900,1985,1991,1998,2003,2008,2013,2018,2023]
# borrow_sum.xaxis.set_major_locator(FixedLocator(year.index))
...
plt.tight_layout()
plt.savefig("../rendering/写作日期_str.png")
plt.show()
