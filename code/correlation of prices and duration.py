...
fig, (lend_duration_sum,lend_times) = plt.subplots(2,1,figsize=(10,8))
...
lend_duration_sum.set_title('书籍价格 vs 平均借阅时间散点图')
...
lend_duration_sum.set_title('书籍价格 vs 总借入次数散点图')
